...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(count) =>
      "${Intl.plural(count, zero: 'إضافة مُشَاهِدِين', one: 'إضافة مُشَاهِد', other: 'إضافة مُشَاهِدِين')}";
  ...
  static String m17(expiryTime) => " ستنتهي صَلاحية الرابط في ${expiryTime}";

  static String m18(count, formattedCount) =>
      "${Intl.plural(count, zero: 'لا ذكريات', one: '${formattedCount} ذِكرى واحدة', other: '${formattedCount} ذكريات')}";
  ...
  static String m23(storeName) => "قيّمنا على ${storeName}";
  ...
  static String m26(endDate) => "يتم تجديد الاشتراك في ${endDate}";

  static String m27(count) => "تم اختيار ${count}";
  ...
  static String m33(fileType) => "سيتم حذف ${fileType} من جهازك.";

  static String m34(fileType) => "${fileType} موجود في كلٍ من Ente وجهازك.";

  static String m35(fileType) => "سيتم حذف ${fileType} من Ente.";
  ...
  static String m38(endDate) => "سيتم إلغاء اشتراكك في ${endDate}";

  static String m39(storageAmountInGB) =>
      "سيحصلون أيضًا على ${storageAmountInGB} GB";

  static String m40(email) => "هذا هو معرف التحقق الخاص بـ ${email}";

  static String m41(endDate) => "صالِح حتى ${endDate}";

  static String m42(email) => "التحقق من ${email}";

  static String m43(email) => "أرسلنا بريدًا إلى <green>${email}</green>";

  static String m44(count) =>
      "${Intl.plural(count, one: 'قبل ${count} سنة', two: 'قبل ${count} سنتين', other: 'قبل ${count} سنوات')}";

  static String m45(storageSaved) => "تم تحرير ${storageSaved} بنجاح!";
