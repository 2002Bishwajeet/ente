...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m49(emailOrName) => "Added by ${emailOrName}";

  static String m50(albumName) => "Added successfully to  ${albumName}";

  static String m51(name) => "Admiring ${name}";
  ...
  static String m54(name) => "Beautiful views with ${name}";
  ...
  static String m55(albumName) => "Collaborative link created for ${albumName}";
  ...
  static String m58(endpoint) => "Connected to ${endpoint}";
  ...
  static String m60(newEmail) => "Email changed to ${newEmail}";

  static String m61(email) => "${email} does not have an Ente account.";

  static String m13(email) =>
      "${email} does not have an Ente account.\n\nSend them an invite to share photos.";

  static String m62(name) => "Embracing ${name}";

  static String m63(text) => "Extra photos found for ${text}";

  static String m64(name) => "Feasting with ${name}";
  ...
  static String m15(endDate) => "Free trial valid till ${endDate}";
  ...
  static String m68(sizeInMBorGB) => "Free up ${sizeInMBorGB}";
  ...
  static String m71(name) => "Hiking with ${name}";

  static String m16(count) =>
      "${Intl.plural(count, one: '${count} item', other: '${count} items')}";

  static String m72(name) => "Last time with ${name}";
  ...
  static String m74(email) => "Link person to ${email}";
  ...
  static String m23(storeName) => "Rate us on ${storeName}";
  ...
  static String m26(endDate) => "Subscription renews on ${endDate}";
  ...
  static String m27(count) => "${count} selected";
  ...
  static String m35(fileType) => "This ${fileType} will be deleted from Ente.";
  ...
  static String m40(email) => "This is ${email}\'s Verification ID";
  ...
  static String m41(endDate) => "Valid till ${endDate}";
  ...
  static String m43(email) => "We have sent a mail to <green>${email}</green>";
