...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m46(title) => "${title} (Moi)";
  ...
  static String m49(emailOrName) => "Ajouté par ${emailOrName}";

  static String m50(albumName) => "Ajouté avec succès à  ${albumName}";

  static String m51(name) => "Admirant ${name}";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Aucun Participant', one: '1 Participant', other: '${count} Participants')}";

  static String m52(versionValue) => "Version : ${versionValue}";

  static String m53(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} libre";

  static String m54(name) => "Magnifiques vues avec ${name}";
  ...
  static String m55(albumName) => "Lien collaboratif créé pour ${albumName}";
  ...
  static String m58(endpoint) => "Connecté à ${endpoint}";
  ...
  static String m60(newEmail) => "L\'email a été changé par ${newEmail}";

  static String m61(email) => "${email} n\'a pas de compte Ente.";

  static String m13(email) =>
      "${email} n\'a pas de compte Ente.\n\nEnvoyez une invitation pour partager des photos.";

  static String m62(name) => "Embrasse ${name}";

  static String m63(text) => "Photos supplémentaires trouvées pour ${text}";

  static String m64(name) => "Fête avec ${name}";
  ...
  static String m15(endDate) => "Essai gratuit valide jusqu’au ${endDate}";
  ...
  static String m68(sizeInMBorGB) => "Libérer ${sizeInMBorGB}";
  ...
  static String m71(name) => "Randonnée avec ${name}";

  static String m16(count) =>
      "${Intl.plural(count, one: '${count} objet', other: '${count} objets')}";

  static String m72(name) => "Dernière fois avec ${name}";

  static String m73(email) =>
      "${email} vous a invité à être un contact de confiance";

  static String m17(expiryTime) => "Le lien expirera le ${expiryTime}";

  static String m74(email) => "Associer la personne à ${email}";
  ...
  static String m23(storeName) => "Laissez une note sur ${storeName}";
  ...
  static String m26(endDate) => "Renouvellement le ${endDate}";
  ...
  static String m27(count) => "${count} sélectionné(s)";
  ...
  static String m35(fileType) => "Cette ${fileType} sera supprimée de l\'Ente.";

  static String m98(name) => "Sports avec ${name}";

  static String m99(name) => "Spotlight sur ${name}";

  static String m36(storageAmountInGB) => "${storageAmountInGB} Go";
  ...
  static String m38(endDate) => "Votre abonnement sera annulé le ${endDate}";
  ...
  static String m40(email) => "Ceci est l\'ID de vérification de ${email}";
  ...
  static String m41(endDate) => "Valable jusqu\'au ${endDate}";

  static String m42(email) => "Vérifier ${email}";
