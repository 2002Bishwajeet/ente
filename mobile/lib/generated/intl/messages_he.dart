...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(endDate) => "ניסיון חינם בתוקף עד ל-${endDate}";

  static String m16(count) =>
      "${Intl.plural(count, one: '${count} פריט', two: '${count} פריטים', many: '${count} פריטים', other: '${count} פריטים')}";

  static String m17(expiryTime) => "תוקף הקישור יפוג ב-${expiryTime}";
  ...
  static String m23(storeName) => "דרג אותנו ב-${storeName}";

  static String m24(storageInGB) => "3. שניכים מקבלים ${storageInGB} GB* בחינם";

  static String m25(userEmail) =>
      "${userEmail} יוסר מהאלבום המשותף הזה\n\nגם תמונות שנוספו על ידיהם יוסרו מהאלבום";

  static String m27(count) => "${count} נבחרו";

  static String m28(count, yourCount) => "${count} נבחרו (${yourCount} שלך)";
  ...
  static String m33(fileType) => "${fileType} יימחק מהמכשיר שלך.";

  static String m36(storageAmountInGB) => "${storageAmountInGB} GB";

  static String m38(endDate) => "המנוי שלך יבוטל ב-${endDate}";

  static String m101(completed, total) => "${completed}/${total} זכרונות נשמרו";

  static String m39(storageAmountInGB) => "הם גם יקבלו ${storageAmountInGB} GB";

  static String m40(email) => "זה מזהה האימות של ${email}";

  static String m42(email) => "אמת ${email}";

  static String m43(email) => "שלחנו דוא\"ל ל<green>${email}</green>";

  static String m44(count) =>
      "${Intl.plural(count, one: 'לפני ${count} שנה', two: 'לפני ${count} שנים', many: 'לפני ${count} שנים', other: 'לפני ${count} שנים')}";

  static String m45(storageSaved) => "הצלחת לפנות ${storageSaved}!";
