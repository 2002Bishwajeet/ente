...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m48(count) => "${Intl.plural(count, other: 'Tambahkan item')}";

  static String m0(storageAmount, endDate) =>
      "Add-on ${storageAmount} kamu berlaku sampai ${endDate}";

  static String m49(emailOrName) => "Ditambahkan oleh ${emailOrName}";

  static String m50(albumName) => "Berhasil ditambahkan ke ${albumName}";

  static String m2(count) =>
      "${Intl.plural(count, zero: '0 Peserta', one: '1 Peserta', other: '${count} Peserta')}";

  static String m52(versionValue) => "Versi: ${versionValue}";
  ...
  static String m55(albumName) => "Link kolaborasi terbuat untuk ${albumName}";
  ...
  static String m58(endpoint) => "Terhubung ke ${endpoint}";
  ...
  static String m60(newEmail) => "Email diubah menjadi ${newEmail}";
  ...
  static String m16(count) => "${Intl.plural(count, other: '${count} item')}";

  static String m17(expiryTime) => "Link akan kedaluwarsa pada ${expiryTime}";
  ...
  static String m76(count) => "${Intl.plural(count, other: 'Pindahkan item')}";
  ...
  static String m23(storeName) => "Beri nilai di ${storeName}";
  ...
  static String m26(endDate) => "Langganan akan diperpanjang pada ${endDate}";

  static String m94(count) =>
      "${Intl.plural(count, other: '${count} hasil ditemukan')}";

  static String m27(count) => "${count} terpilih";
  ...
  static String m35(fileType) => "${fileType} ini akan dihapus dari Ente.";
  ...
  static String m40(email) => "Ini adalah ID Verifikasi milik ${email}";

  static String m41(endDate) => "Berlaku hingga ${endDate}";

  static String m42(email) => "Verifikasi ${email}";
