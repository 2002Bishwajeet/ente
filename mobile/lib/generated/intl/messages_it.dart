...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m46(title) => "${title} (Io)";
  ...
  static String m49(emailOrName) => "Aggiunto da ${emailOrName}";

  static String m50(albumName) => "Aggiunto con successo su ${albumName}";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Nessun partecipante', one: '1 Partecipante', other: '${count} Partecipanti')}";

  static String m52(versionValue) => "Versione: ${versionValue}";
  ...
  static String m55(albumName) => "Link collaborativo creato per ${albumName}";
  ...
  static String m58(endpoint) => "Connesso a ${endpoint}";
  ...
  static String m60(newEmail) => "Email cambiata in ${newEmail}";

  static String m13(email) =>
      "${email} non ha un account Ente.\n\nInvia un invito per condividere foto.";

  static String m63(text) => "Trovate foto aggiuntive per ${text}";
  ...
  static String m17(expiryTime) => "Il link scadrà il ${expiryTime}";

  static String m74(email) => "Collega persona a ${email}";
  ...
  static String m23(storeName) => "Valutaci su ${storeName}";
  ...
  static String m35(fileType) => "Questo ${fileType} verrà eliminato da Ente.";
  ...
  static String m38(endDate) => "L\'abbonamento verrà cancellato il ${endDate}";
  ...
  static String m40(email) => "Questo è l\'ID di verifica di ${email}";
  ...
  static String m41(endDate) => "Valido fino al ${endDate}";

  static String m42(email) => "Verifica ${email}";
