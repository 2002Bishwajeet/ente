...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m46(title) => "${title} (私)";
  ...
  static String m49(emailOrName) => "${emailOrName} が追加";

  static String m50(albumName) => "${albumName} に追加しました";

  static String m51(name) => "${name}に注目！";

  static String m2(count) =>
      "${Intl.plural(count, zero: '参加者なし', one: '1 参加者', other: '${count} 参加者')}";

  static String m52(versionValue) => "バージョン: ${versionValue}";

  static String m53(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} 無料";

  static String m54(name) => "${name}と見た美しい景色！";
  ...
  static String m55(albumName) => "${albumName} のコラボレーションリンクを生成しました";
  ...
  static String m58(endpoint) => "${endpoint} に接続しました";
  ...
  static String m9(albumName) => "\"${albumName}\" にアクセスするための公開リンクが削除されます。";
  ...
  static String m60(newEmail) => "メールアドレスが ${newEmail} に変更されました";

  static String m61(email) => "${email} は Ente アカウントを持っていません。";

  static String m13(email) =>
      "${email} はEnteアカウントを持っていません。\n\n写真を共有するために「招待」を送信してください。";

  static String m62(name) => "${name}抱きしめて！";

  static String m63(text) => "${text} の写真が見つかりました";

  static String m64(name) => "${name}とご飯！";
  ...
  static String m15(endDate) => "無料トライアルは${endDate} までです";

  static String m67(count) =>
      "あなたが有効なサブスクリプションを持っている限りEnte上の ${Intl.plural(count, other: 'それらに')} アクセスできます";

  static String m68(sizeInMBorGB) => "${sizeInMBorGB} を解放する";
  ...
  static String m71(name) => "${name}とハイキング！";

  static String m16(count) => "${Intl.plural(count, other: '${count}個のアイテム')}";

  static String m72(name) => "前回の${name}との時間";

  static String m73(email) => "${email} があなたを信頼する連絡先として招待しました";

  static String m17(expiryTime) => "リンクは ${expiryTime} に期限切れになります";

  static String m74(email) => "この人物を ${email}に紐づけ";

  static String m75(personName, email) => "${personName} を ${email} に紐づけします";
  ...
  static String m21(providerName) => "請求された場合は、 ${providerName} のサポートに連絡してください";
  ...
  static String m23(storeName) => "${storeName} で評価";
  ...
  static String m24(storageInGB) => "3. お二人とも ${storageInGB} GB*を無料で手に入ります。";

  static String m25(userEmail) =>
      "${userEmail} はこの共有アルバムから退出します\n\n${userEmail} が追加した写真もアルバムから削除されます";

  static String m26(endDate) => "サブスクリプションは ${endDate} に更新します";
  ...
  static String m27(count) => "${count} 個を選択";

  static String m28(count, yourCount) => "${count} 個選択中（${yourCount} あなた）";

  static String m96(name) => "${name}とセルフィー！";

  static String m29(verificationID) => "私の確認ID: ente.ioの ${verificationID}";
  ...
  static String m34(fileType) => "この ${fileType} はEnteとお使いのデバイスの両方にあります。";

  static String m35(fileType) => "${fileType} はEnteから削除されます。";
  ...
  static String m38(endDate) => "サブスクリプションは ${endDate} でキャンセルされます";
  ...
  static String m39(storageAmountInGB) => "紹介者も ${storageAmountInGB} GB を得ます";

  static String m40(email) => "これは ${email} の確認用ID";
  ...
  static String m41(endDate) => "${endDate} まで";

  static String m42(email) => "${email} を確認";

  static String m112(count) =>
      "${Intl.plural(count, zero: '${count}人のビューアーを追加', one: '${count}人のビューアーを追加', other: '${count}人のビューアーを追加')}";

  static String m43(email) => "<green>${email}</green>にメールを送りました";
  ...
  static String m45(storageSaved) => "${storageSaved} を解放しました";
