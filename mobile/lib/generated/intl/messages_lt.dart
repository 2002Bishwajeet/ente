...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m46(title) => "${title} (Aš)";
  ...
  static String m51(name) => "Žavisi ${name}";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Nėra dalyvių', one: '1 dalyvis', other: '${count} dalyviai')}";

  static String m52(versionValue) => "Versija: ${versionValue}";

  static String m54(name) => "Gražūs vaizdai su ${name}";
  ...
  static String m58(endpoint) => "Prijungta prie ${endpoint}";
  ...
  static String m60(newEmail) => "El. paštas pakeistas į ${newEmail}";

  static String m61(email) => "${email} neturi „Ente“ paskyros.";

  static String m13(email) =>
      "${email} neturi „Ente“ paskyros.\n\nSiųskite jiems kvietimą bendrinti nuotraukas.";

  static String m63(text) => "Rastos papildomos nuotraukos, skirtos ${text}";
  ...
  static String m68(sizeInMBorGB) => "Atlaisvinti ${sizeInMBorGB}";
  ...
  static String m73(email) => "${email} pakvietė jus būti patikimu kontaktu";

  static String m17(expiryTime) => "Nuoroda nebegalios ${expiryTime}";
  ...
  static String m23(storeName) => "Vertinti mus parduotuvėje „${storeName}“";
  ...
  static String m26(endDate) => "Prenumerata pratęsiama ${endDate}";
  ...
  static String m27(count) => "${count} pasirinkta";
  ...
  static String m35(fileType) => "Šis ${fileType} bus ištrintas iš „Ente“.";
  ...
  static String m38(endDate) => "Jūsų prenumerata bus atsisakyta ${endDate}";
  ...
  static String m40(email) => "Tai – ${email} patvirtinimo ID";
  ...
  static String m41(endDate) => "Galioja iki ${endDate}";

  static String m42(email) => "Patvirtinti ${email}";
  ...
  static String m45(storageSaved) => "Sėkmingai atlaisvinote ${storageSaved}!";
