...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m46(title) => "${title} (Ik)";
  ...
  static String m49(emailOrName) => "Toegevoegd door ${emailOrName}";

  static String m50(albumName) => "Succesvol toegevoegd aan  ${albumName}";

  static String m51(name) => "${name} bewonderen";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Geen deelnemers', one: '1 deelnemer', other: '${count} deelnemers')}";

  static String m52(versionValue) => "Versie: ${versionValue}";

  static String m53(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} vrij";

  static String m54(name) => "Prachtige uitzichten met ${name}";
  ...
  static String m58(endpoint) => "Verbonden met ${endpoint}";
  ...
  static String m60(newEmail) => "E-mailadres gewijzigd naar ${newEmail}";

  static String m61(email) => "${email} heeft geen Ente account.";

  static String m13(email) =>
      "${email} heeft geen Ente account.\n\nStuur ze een uitnodiging om foto\'s te delen.";

  static String m62(name) => "${name} omarmen";

  static String m63(text) => "Extra foto\'s gevonden voor ${text}";

  static String m64(name) => "Feestmaal met ${name}";
  ...
  static String m15(endDate) => "Gratis proefversie geldig tot ${endDate}";
  ...
  static String m68(sizeInMBorGB) => "Maak ${sizeInMBorGB} vrij";
  ...
  static String m71(name) => "Wandelen met ${name}";

  static String m16(count) =>
      "${Intl.plural(count, one: '${count} item', other: '${count} items')}";

  static String m72(name) => "Laatste keer met ${name}";

  static String m73(email) =>
      "${email} heeft je uitgenodigd om een vertrouwd contact te zijn";

  static String m17(expiryTime) => "Link vervalt op ${expiryTime}";

  static String m74(email) => "Link persoon aan ${email}";
  ...
  static String m23(storeName) => "Beoordeel ons op ${storeName}";
  ...
  static String m26(endDate) => "Wordt verlengd op ${endDate}";
  ...
  static String m27(count) => "${count} geselecteerd";
  ...
  static String m38(endDate) => "Uw abonnement loopt af op ${endDate}";
  ...
  static String m40(email) => "Dit is de verificatie-ID van ${email}";
  ...
  static String m41(endDate) => "Geldig tot ${endDate}";

  static String m42(email) => "Verifieer ${email}";
