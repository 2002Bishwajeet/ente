...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m49(emailOrName) => "Dodane przez ${emailOrName}";

  static String m50(albumName) => "Pomyślnie dodano do  ${albumName}";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Brak Uczestników', one: '1 Uczestnik', other: '${count} Uczestników')}";

  static String m52(versionValue) => "Wersja: ${versionValue}";
  ...
  static String m55(albumName) => "Utworzono link współpracy dla ${albumName}";
  ...
  static String m58(endpoint) => "Połączono z ${endpoint}";
  ...
  static String m60(newEmail) => "Adres e-mail został zmieniony na ${newEmail}";

  static String m13(email) =>
      "${email} nie posiada konta Ente.\n\nWyślij im zaproszenie do udostępniania zdjęć.";

  static String m63(text) => "Znaleziono dodatkowe zdjęcia dla ${text}";
  ...
  static String m15(endDate) => "Okres próbny ważny do ${endDate}";
  ...
  static String m68(sizeInMBorGB) => "Zwolnij ${sizeInMBorGB}";
  ...
  static String m17(expiryTime) => "Link wygaśnie ${expiryTime}";
  ...
  static String m23(storeName) => "Oceń nas na ${storeName}";
  ...
  static String m26(endDate) => "Subskrypcja odnowi się ${endDate}";
  ...
  static String m27(count) => "Wybrano ${count}";
  ...
  static String m35(fileType) => "Ten ${fileType} zostanie usunięty z Ente.";
  ...
  static String m40(email) => "To jest identyfikator weryfikacyjny ${email}";
  ...
  static String m41(endDate) => "Ważne do ${endDate}";

  static String m42(email) => "Zweryfikuj ${email}";
  ...
  static String m45(storageSaved) => "Pomyślnie zwolniłeś/aś ${storageSaved}!";
