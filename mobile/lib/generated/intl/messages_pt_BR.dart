...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m46(title) => "${title} (Eu)";
  ...
  static String m49(emailOrName) => "Adicionado por ${emailOrName}";

  static String m50(albumName) => "Adicionado com sucesso a  ${albumName}";

  static String m51(name) => "Admirando ${name}";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Nenhum participante', one: '1 participante', other: '${count} participantes')}";

  static String m52(versionValue) => "Versão: ${versionValue}";

  static String m53(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} livre";

  static String m54(name) => "Vistas bonitas com ${name}";
  ...
  static String m55(albumName) => "Link colaborativo criado para ${albumName}";
  ...
  static String m58(endpoint) => "Conectado à ${endpoint}";
  ...
  static String m60(newEmail) => "E-mail alterado para ${newEmail}";

  static String m61(email) => "${email} não possui uma conta Ente.";

  static String m13(email) =>
      "${email} não tem uma conta Ente.\n\nEnvie-os um convite para compartilhar fotos.";

  static String m62(name) => "Abraçando ${name}";

  static String m63(text) => "Fotos adicionais encontradas para ${text}";

  static String m64(name) => "Tendo banquete com ${name}";
  ...
  static String m15(endDate) => "A avaliação grátis acaba em ${endDate}";
  ...
  static String m68(sizeInMBorGB) => "Liberar ${sizeInMBorGB}";
  ...
  static String m71(name) => "Caminhando com ${name}";

  static String m16(count) =>
      "${Intl.plural(count, one: '${count} item', other: '${count} itens')}";

  static String m72(name) => "Últimos momentos com ${name}";

  static String m73(email) =>
      "${email} convidou você para ser um contato confiável";

  static String m17(expiryTime) => "O link expirará em ${expiryTime}";

  static String m74(email) => "Vincular pessoa a ${email}";

  static String m75(personName, email) =>
  ...
  static String m23(storeName) => "Avalie-nos no ${storeName}";
  ...
  static String m26(endDate) => "Renovação de assinatura em ${endDate}";
  ...
  static String m27(count) => "${count} selecionado(s)";
  ...
  static String m35(fileType) => "Este ${fileType} será excluído do Ente.";
  ...
  static String m38(endDate) => "Sua assinatura será cancelada em ${endDate}";
  ...
  static String m40(email) => "Este é o ID de verificação de ${email}";
  ...
  static String m41(endDate) => "Válido até ${endDate}";

  static String m42(email) => "Verificar ${email}";
  ...
  static String m43(email) => "Enviamos um e-mail à <green>${email}</green>";
