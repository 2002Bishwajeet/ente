...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m60(newEmail) => "Email alterado para ${newEmail}";

  static String m13(email) =>
      "${email} não possui uma conta Ente.\n\nEnvie um convite para compartilhar fotos.";

  static String m63(text) => "Fotos extras encontradas para ${text}";
  ...
  static String m15(endDate) => "Teste gratuito válido até ${endDate}";

  static String m67(count) =>
      "Ainda pode aceder a ${Intl.plural(count, one: 'ele', other: 'eles')} no Ente desde que tenha uma subscrição ativa";

  static String m68(sizeInMBorGB) => "Libertar ${sizeInMBorGB}";

  static String m69(count, formattedSize) =>
      "${Intl.plural(count, one: 'Pode ser apagado do dispositivo para libertar ${formattedSize}', other: 'Pode ser apagado do dispositivo para libertar ${formattedSize}')}";
  ...
  static String m23(storeName) => "Avalie-nos em ${storeName}";

  static String m24(storageInGB) => "3. Ambos ganham ${storageInGB} GB* grátis";
  ...
  static String m26(endDate) => "A subscrição é renovada em ${endDate}";
  ...
  static String m35(fileType) => "Este ${fileType} será eliminado do Ente.";
  ...
  static String m38(endDate) => "A sua subscrição será cancelada em ${endDate}";
  ...
  static String m42(email) => "Verificar e-mail";
  ...
  static String m43(email) => "Enviamos um e-mail para <green>${email}</green>";
