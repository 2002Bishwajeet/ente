...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m49(emailOrName) => "Adăugat de ${emailOrName}";

  static String m50(albumName) => "S-au adăugat cu succes la ${albumName}";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Fără participanți', one: '1 participant', other: '${count} de participanți')}";

  static String m52(versionValue) => "Versiune: ${versionValue}";
  ...
  static String m55(albumName) => "Link colaborativ creat pentru ${albumName}";
  ...
  static String m58(endpoint) => "Conectat la ${endpoint}";
  ...
  static String m60(newEmail) => "E-mail modificat în ${newEmail}";

  static String m13(email) =>
      "${email} nu are un cont Ente.\n\nTrimiteți-le o invitație pentru a distribui fotografii.";

  static String m63(text) => "S-au găsit fotografii extra pentru ${text}";
  ...
  static String m68(sizeInMBorGB) => "Eliberați ${sizeInMBorGB}";
  ...
  static String m17(expiryTime) => "Linkul va expira pe ${expiryTime}";
  ...
  static String m23(storeName) => "Evaluați-ne pe ${storeName}";
  ...
  static String m26(endDate) => "Abonamentul se reînnoiește pe ${endDate}";
  ...
  static String m27(count) => "${count} selectate";
  ...
  static String m38(endDate) => "Abonamentul dvs. va fi anulat pe ${endDate}";
  ...
  static String m40(email) => "Acesta este ID-ul de verificare al ${email}";
  ...
  static String m41(endDate) => "Valabil până pe ${endDate}";

  static String m42(email) => "Verificare ${email}";

  static String m43(email) => "Am trimis un e-mail la <green>${email}</green>";

  static String m44(count) =>
      "${Intl.plural(count, one: 'acum ${count} an', few: 'acum ${count} ani', other: 'acum ${count} de ani')}";

  static String m45(storageSaved) => "Ați eliberat cu succes ${storageSaved}!";
