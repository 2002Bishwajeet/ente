...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m17(expiryTime) => "Länken upphör att gälla ${expiryTime}";
  ...
  static String m23(storeName) => "Betygsätt oss på ${storeName}";

  static String m24(storageInGB) => "3. Ni får båda ${storageInGB} GB* gratis";
  ...
  static String m40(email) => "Detta är ${email}s verifierings-ID";

  static String m111(count) => "Bevarar ${count} minnen...";

  static String m42(email) => "Bekräfta ${email}";
