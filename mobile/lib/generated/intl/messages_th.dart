...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m48(count) => "${Intl.plural(count, other: 'เพิ่มรายการ')}";

  static String m52(versionValue) => "รุ่น: ${versionValue}";
  ...
  static String m16(count) => "${Intl.plural(count, other: '${count} รายการ')}";

  static String m76(count) => "${Intl.plural(count, other: 'ย้ายรายการ')}";
  ...
  static String m43(email) => "เราได้ส่งจดหมายไปยัง <green>${email}</green>";
