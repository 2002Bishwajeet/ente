...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m49(emailOrName) => "Додано ${emailOrName}";

  static String m50(albumName) => "Успішно додано до «${albumName}»";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Немає учасників', one: '1 учасник', other: '${count} учасників')}";

  static String m52(versionValue) => "Версія: ${versionValue}";
  ...
  static String m58(endpoint) => "Під\'єднано до ${endpoint}";
  ...
  static String m60(newEmail) => "Поштову адресу змінено на ${newEmail}";

  static String m13(email) =>
      "У ${email} немає облікового запису Ente.\n\nНадішліть їм запрошення для обміну фотографіями.";

  static String m63(text) => "Знайдено додаткові фотографії для ${text}";
  ...
  static String m15(endDate) => "Безплатна пробна версія діє до ${endDate}";
  ...
  static String m68(sizeInMBorGB) => "Звільніть ${sizeInMBorGB}";
  ...
  static String m73(email) => "${email} запросив вас стати довіреною особою";

  static String m17(expiryTime) => "Посилання закінчується через ${expiryTime}";
  ...
  static String m23(storeName) => "Оцініть нас в ${storeName}";
  ...
  static String m26(endDate) => "Передплата поновиться ${endDate}";
  ...
  static String m27(count) => "${count} вибрано";

  static String m28(count, yourCount) => "${count} вибрано (${yourCount} ваші)";
  ...
  static String m33(fileType) => "Цей ${fileType} буде видалено з пристрою.";

  static String m34(fileType) =>
      "Цей ${fileType} знаходиться і в Ente, і на вашому пристрої.";

  static String m35(fileType) => "Цей ${fileType} буде видалено з Ente.";
  ...
  static String m38(endDate) => "Вашу передплату буде скасовано ${endDate}";
  ...
  static String m40(email) => "Це ідентифікатор підтвердження пошти ${email}";
  ...
  static String m41(endDate) => "Діє до ${endDate}";

  static String m42(email) => "Підтвердити ${email}";
  ...
  static String m43(email) => "Ми надіслали листа на <green>${email}</green>";

  static String m44(count) =>
      "${Intl.plural(count, one: '${count} рік тому', few: '${count} роки тому', many: '${count} років тому', other: '${count} років тому')}";

  static String m45(storageSaved) => "Ви успішно звільнили ${storageSaved}!";
