...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m49(emailOrName) => "Được thêm bởi ${emailOrName}";

  static String m50(albumName) => "Đã thêm thành công vào ${albumName}";

  static String m2(count) =>
      "${Intl.plural(count, zero: 'Không có người tham gia', one: '1 người tham gia', other: '${count} Người tham gia')}";

  static String m52(versionValue) => "Phiên bản: ${versionValue}";
  ...
  static String m58(endpoint) => "Đã kết nối với ${endpoint}";
  ...
  static String m60(newEmail) => "Email đã được thay đổi thành ${newEmail}";
  ...
  static String m15(endDate) => "Dùng thử miễn phí có hiệu lực đến ${endDate}";
  ...
  static String m68(sizeInMBorGB) => "Giải phóng ${sizeInMBorGB}";
  ...
  static String m17(expiryTime) => "Liên kết sẽ hết hạn vào ${expiryTime}";
  ...
  static String m23(storeName) => "Đánh giá chúng tôi trên ${storeName}";
  ...
  static String m26(endDate) => "Đăng ký sẽ được gia hạn vào ${endDate}";
  ...
  static String m27(count) => "${count} đã chọn";
  ...
  static String m35(fileType) => "Tệp ${fileType} này sẽ bị xóa khỏi Ente.";
  ...
  static String m38(endDate) => "Đăng ký của bạn sẽ bị hủy vào ${endDate}";
  ...
  static String m40(email) => "Đây là ID xác minh của ${email}";
  ...
  static String m41(endDate) => "Có hiệu lực đến ${endDate}";

  static String m42(email) => "Xác minh ${email}";
