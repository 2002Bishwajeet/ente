...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m46(title) => "${title} (我)";
  ...
  static String m49(emailOrName) => "由 ${emailOrName} 添加";

  static String m50(albumName) => "成功添加到  ${albumName}";

  static String m51(name) => "欣赏 ${name}";

  static String m2(count) =>
      "${Intl.plural(count, zero: '无参与者', one: '1个参与者', other: '${count} 个参与者')}";

  static String m52(versionValue) => "版本: ${versionValue}";

  static String m53(freeAmount, storageUnit) =>
      "${freeAmount} ${storageUnit} 空闲";

  static String m54(name) => "与 ${name} 一起欣赏美景";

  static String m3(paymentProvider) => "请先取消您现有的订阅 ${paymentProvider}";
  ...
  static String m55(albumName) => "为 ${albumName} 创建了协作链接";
  ...
  static String m58(endpoint) => "已连接至 ${endpoint}";
  ...
  static String m9(albumName) => "这将删除用于访问\"${albumName}\"的公开链接。";

  static String m10(supportEmail) => "请从您注册的邮箱发送一封邮件到 ${supportEmail}";
  ...
  static String m60(newEmail) => "电子邮件已更改为 ${newEmail}";

  static String m61(email) => "${email} 没有 Ente 账户。";

  static String m13(email) => "${email} 没有 Ente 帐户。\n\n向他们发出共享照片的邀请。";

  static String m62(name) => "拥抱 ${name}";

  static String m63(text) => "为 ${text} 找到额外照片";

  static String m64(name) => "与 ${name} 的盛宴";
  ...
  static String m15(endDate) => "免费试用有效期至 ${endDate}";

  static String m67(count) =>
      "只要您有有效的订阅，您仍然可以在 Ente 上访问 ${Intl.plural(count, one: '它', other: '它们')}";

  static String m68(sizeInMBorGB) => "释放 ${sizeInMBorGB}";
  ...
  static String m71(name) => "与 ${name} 徒步";

  static String m16(count) =>
      "${Intl.plural(count, one: '${count} 个项目', other: '${count} 个项目')}";

  static String m72(name) => "最后一次与 ${name} 相聚";

  static String m73(email) => "${email} 已邀请您成为可信联系人";

  static String m17(expiryTime) => "链接将在 ${expiryTime} 过期";

  static String m74(email) => "将人员链接到 ${email}";

  static String m75(personName, email) => "这将会将 ${personName} 链接到 ${email}";
  ...
  static String m19(familyAdminEmail) => "请联系${familyAdminEmail} 以更改您的代码。";

  static String m80(name) => "与 ${name} 开派对";

  static String m20(passwordStrengthValue) => "密码强度： ${passwordStrengthValue}";

  static String m21(providerName) => "如果您被收取费用，请用英语与 ${providerName} 的客服聊天";
  ...
  static String m22(endDate) => "免费试用有效期至 ${endDate}。\n在此之后您可以选择付费计划。";
  ...
  static String m23(storeName) => "在 ${storeName} 上给我们评分";
  ...
  static String m24(storageInGB) => "3. 你和朋友都将免费获得 ${storageInGB} GB*";

  static String m25(userEmail) =>
      "${userEmail} 将从这个共享相册中删除\n\nTA们添加的任何照片也将从相册中删除";

  static String m26(endDate) => "在 ${endDate} 前续费";
  ...
  static String m27(count) => "已选择 ${count} 个";

  static String m28(count, yourCount) => "选择了 ${count} 个 (您的 ${yourCount} 个)";

  static String m96(name) => "与 ${name} 的自拍";

  static String m29(verificationID) => "这是我的ente.io 的验证 ID： ${verificationID}。";
  ...
  static String m33(fileType) => "此 ${fileType} 将从您的设备中删除。";

  static String m34(fileType) => "${fileType} 已同时存在于 Ente 和您的设备中。";

  static String m35(fileType) => "${fileType} 将从 Ente 中删除。";

  static String m98(name) => "与 ${name} 一起运动";

  static String m99(name) => "聚光灯下的 ${name}";

  static String m36(storageAmountInGB) => "${storageAmountInGB} GB";
  ...
  static String m38(endDate) => "您的订阅将于 ${endDate} 取消";

  static String m101(completed, total) => "已保存的回忆 ${completed}/共 ${total}";

  static String m102(ignoreReason) => "点按上传，由于${ignoreReason}，目前上传已被忽略";

  static String m39(storageAmountInGB) => "他们也会获得 ${storageAmountInGB} GB";

  static String m40(email) => "这是 ${email} 的验证ID";
  ...
  static String m41(endDate) => "有效期至 ${endDate}";

  static String m42(email) => "验证 ${email}";

  static String m112(count) =>
      "${Intl.plural(count, zero: '已添加 0 位查看者', one: '已添加 1 位查看者', other: '已添加 ${count} 位查看者')}";

  static String m43(email) => "我们已经发送邮件到 <green>${email}</green>";
  ...
  static String m45(storageSaved) => "您已成功释放了 ${storageSaved}！";
